...
function (_Component) {
  ...
  function Item(_props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "onMouseDown", function (e) {
      if (!_this.props.selected) _this.props.onSelect(_this.itemId, "mouse", e);
      e.stopPropagation();
  ...
  _createClass(Item, [{
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      var couldDrag = this.canMove(prevProps);
      var couldResizeLeft = this.canResizeLeft(prevProps);
      var couldResizeRight = this.canResizeRight(prevProps);
      var willBeAbleToDrag = this.canMove(this.props);
      var willBeAbleToResizeLeft = this.canResizeLeft(this.props);
      var willBeAbleToResizeRight = this.canResizeRight(this.props);
